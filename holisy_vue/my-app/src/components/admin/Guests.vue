...
<script>
  export default {
    ...
    methods: {
        async loadListGuests() {
            this.listGuests = await fetch(
                `${this.$store.getters.getServerUrl}clients/`
            ).then(response => response.json())
        },

        editItem (item) {
            this.editedIndex = this.listGuests.indexOf(item)
        ...
        async deleteItemConfirm () {
            await this.loadListGuests();
            await fetch(
                `${this.$store.getters.getServerUrl}user/delete/${this.client.user_id}/`,
                {
                  method: 'delete',
                  headers: {
        ...
        async editGuest () {
          await fetch(
              `${this.$store.getters.getServerUrl}user/update/${this.client.user_id}/`,
              {
                method: 'put',
                headers: {
                    'Content-Type': 'application/json'
